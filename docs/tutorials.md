...
For practical examples and step-by-step guides on using the AMD Enterprise AI Workloads, check out our tutorials:

- [Tutorial 0](tutorials/tutorial-00-prerequisites.md): Shared setup for tutorials.
- [Deliver Resources and Fine-tune](tutorials/tutorial-01-deliver-resources-and-finetune.md): Learn how to download models and data to cluster MinIO storage, run fine-tuning jobs, and deploy inference services.
- [Language extension: Odia-fine-tuning](tutorials/tutorial-02-language-extension-finetune.md): Learn how to fine-tune a continued pretraining base model to make it an instruction following model, then deploy models and compare.
